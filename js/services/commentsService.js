...
app.factory('commentsService', function($http, $q, authenticationService, configService) {
    ...
    service.getPostComments = function getPostComments(postId) {
        ...
        $http.get(serviceUrl + postId + '/comments', authenticationService.getHeaders())
    ...
    service.addCommentToPost = function addCommentToPost(postId, commentContent) {
        ...
        $http.post(serviceUrl + postId + '/comments', data, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.editCommentToPost = function editCommentToPost(postId, commentId, newCommentContent) {
        ...
        $http.put(serviceUrl + postId + '/comments/' + commentId, data, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.deleteCommentToPost = function deleteCommentToPost(postId, commentId, newCommentContent) {
        var deferred = $q.defer();
        $http.delete(serviceUrl + postId + '/comments/' + commentId, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getCommentDetailedLikes = function getCommentDetailedLikes(postId, commentId) {
        var deferred = $q.defer();
        $http.get(serviceUrl + postId + '/comments/' + commentId + '/likes', authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getCommentPreviewLikes = function getCommentPreviewLikes(postId, commentId) {
        var deferred = $q.defer();
        $http.get(serviceUrl + postId + '/comments/' + commentId + '/likes/preview', authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.likeCommnet = function likeCommnet(postId, commentId) {
        var deferred = $q.defer();
        $http.post(serviceUrl + postId + '/comments/' + commentId + '/likes', null, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.unlikeCommnet = function unlikeCommnet(postId, commentId) {
        var deferred = $q.defer();
        $http.delete(serviceUrl + postId + '/comments/' + commentId + '/likes', authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
