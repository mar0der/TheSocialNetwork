...
app.factory('postsService', function ($http, $q, authenticationService, configService) {
    ...
    service.addPost = function addPost(content, username) {
        ...
        return $http.post(serviceUrl, data, authenticationService.getHeaders());
    ...
    service.getPostById = function getPostById(postId) {
        //var deferred = $q.defer();
        return $http.get(serviceUrl + postId, authenticationService.getHeaders());
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
    ...
    service.editPost = function editPost(postId, postContent) {
        ...
        return $http.put(serviceUrl + postId, data, authenticationService.getHeaders())
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
    ...
    service.deletePost = function deletePost(postId) {
        //var deferred = $q.defer();
        return $http.delete(serviceUrl + postId, authenticationService.getHeaders())
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
    ...
    service.getPostDetailedLikes = function getPostDetailedLikes(postId) {
        //var deferred = $q.defer();
        return $http.get(serviceUrl + postId + '/likes', authenticationService.getHeaders());
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
    ...
    service.getPostLikesPreview = function getPostLikesPreview(postId) {
        //var deferred = $q.defer();
        return $http.get(serviceUrl + postId + '/likes/preview', authenticationService.getHeaders());
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
    ...
    service.likePost = function likePost(postId) {
        //var deferred = $q.defer();
        var data = {};
        return $http.post(serviceUrl + postId + '/likes', data, authenticationService.getHeaders());
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
    ...
    service.unlikePost = function unlikePost(postId) {
        //var deferred = $q.defer();
        return $http.delete(serviceUrl + postId + '/likes', authenticationService.getHeaders());
        //    .success(function (responseData) {
        //        deferred.resolve(responseData);
        //    })
        //    .error(function (errorData) {
