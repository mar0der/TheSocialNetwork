...
app.factory('usersService', function ($http, $q, authenticationService, configService) {
    ...
    service.logout = function () {
        var deferred = $q.defer();
        $http.post(serviceUrl + 'logout', null, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getUserPreviewData = function getUserPreviewData(username) {
        var deferred = $q.defer();
        $http.get(serviceUrl + username + '/preview', authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.searchUserByName = function searchUserByName(searchTerm) {
        var deferred = $q.defer();
        $http.get(serviceUrl + 'search?searchTerm=' + searchTerm, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getUserData = function getUserData(username) {
        var deferred = $q.defer();
        $http.get(serviceUrl + username, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getUsersWallByPages = function getFriendUsersByPages(friendName, startPostId, pageSize) {
        var deferred = $q.defer();
        $http.get(serviceUrl + friendName + '/wall?StartPostId=' + startPostId + '&PageSize=' + pageSize, authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getFriendsFriendListPreview = function getFriendsFriendListPreview(friendName) {
        var deferred = $q.defer();
        $http.get(serviceUrl + friendName + '/friends/preview', authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
    ...
    service.getFriendsDetailedFriendList = function getFriendsDetailedFriendList(friendName) {
        var deferred = $q.defer();
        $http.get(serviceUrl + friendName + '/friends', authenticationService.getHeaders())
            .success(function (responseData) {
                deferred.resolve(responseData);
            })
            .error(function (errorData) {
